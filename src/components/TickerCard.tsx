...
export const TickerCard: React.FC<TickerCardProps> = ({ data }) => {
  ...
  return (
    <div className="bg-white rounded-xl border dark:bg-gradient-to-br dark:from-neutral-900 dark:to-neutral-950 border-gray-100 dark:border-none shadow-sm hover:shadow-md transition-shadow duration-300 p-5 flex flex-col">
      {/* Symbol */}
